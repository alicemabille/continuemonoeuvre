...
<body class="bg-primary bg-light">
  <header>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
      <ul class="navbar-nav">
        <li class="nav-item navbar-brand" id="index-nav-item"><a class="nav-link <?php active_page("index.php");?>" href="index.php"><img src="images/logo.png" alt="Continue mon &oelig;uvre" id="logo-header" class="img-fluid rounded" style="width:5em;"/></a></li>
